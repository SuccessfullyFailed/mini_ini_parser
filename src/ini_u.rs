...
mod tests {
	...
	fn test_from_contents_valid() {
		...
		let ini:Ini<String, String> = Ini::<String, String>::from_contents(contents);
	...
	fn test_save_and_load() {
		...
		let loaded_ini:Ini<String, String> = Ini::<String, String>::from_file(temp_file).unwrap();
	...
	fn test_encoding_decoding() {
		...
		let ini:Ini<String, String> = Ini::<String, String>::from_contents_with_encoding(
			contents,
	...
	fn test_create_variable() {
		let contents:&str = "[Missing]\n";
		let mut ini:Ini<String, String> = Ini::<String, String>::from_contents(contents);
