...
mod tests {
	...
	fn test_from_contents_valid() {
		...
		let ini:Ini<String> = Ini::<String>::from_contents(contents);
	...
	fn test_save_and_load() {
		...
		let loaded_ini:Ini<String> = Ini::<String>::from_file(temp_file).unwrap();
	...
	fn test_encoding_decoding() {
		...
		let ini:Ini<String> = Ini::<String>::from_contents_with_encoding(contents, |s| s.replace("_", " "), |s| s.replace(" ", "_"));
